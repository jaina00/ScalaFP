//package codecentric.github
//
//import cats.Applicative
//import cats.`~>`
//import cats.data.{Coproduct, EitherK}
...
//  type GitHubBoth[A] = Free[EitherK[GitHub,GitHubApplicative,?],A]
//
...
//    Free.liftF[EitherK[GitHub,GitHubApplicative,?],List[Comment]](
//      EitherK.left[GitHubApplicative](GetComments(owner, repo, issue)))
//
...
//    Free.liftF[EitherK[GitHub,GitHubApplicative,?],User](
//      EitherK.left[GitHubApplicative](GetUser(login)))
//
...
//    Free.liftF[EitherK[GitHub,GitHubApplicative,?],List[Issue]](
//      EitherK.left[GitHubApplicative](ListIssues(owner,repo)))
//
...
//    Free.liftF[EitherK[GitHub,GitHubApplicative,?],A](EitherK.right(p))
//}
//
//object GitHubInterp {
